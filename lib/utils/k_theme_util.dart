...
class KColor {
  //微信主题色 rgb(59,184,21)
  static const Color kWeiXinThemeColor = Color(0xFF3BB815);

  //rgb(50, 179, 116)
  static const Color kWeiXinPayColor = Color(0xFF32B374);

  //rgb(0, 174, 91)
  static const Color kWeiXinTextColor = Color(0xFF00AE5B);

  //rgb(255, 139, 34)
  static const Color kWeiXinTextOrangeColor = Color(0xFFFF8B22);

  static const Color kWeiXinTitleColor = Colors.white;

  //微信背景色 rgb(237,237,237)
  static const Color kWeiXinBgColor = Color(0xFFEDEDED);

  //深蓝色
  static const Color kWeiXinTextBlueColor = Color(0xFF586D98);

  //灰色文字
  static const Color kTextGrayColor = Color(0xFF999999);

//  static const Color ThemeColor =  Color.fromRGBO(59, 184, 21, 1);
//  static const const Color app_main = Color(0xFF4688FA);

  static const Color kLineColor = Color(0xFFE6E6E6); //230
  static const Color transparent = Colors.transparent;

  static const Color appBarGradientStartColor = Color(0xFF2171F5); //渐变 开始色
  static const Color appBarGradientEndColor = Color(0xF000A2FC); //结束色
